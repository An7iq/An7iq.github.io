...
export const researchZh: Record<string, ResearchOverlay> = {
  "non-rainfall-water": {
    title: "农田非降水水分",
    cardSummary:
      "这项多站点研究量化不同作物与地表条件下常被忽略的夜间大气水分输入。分析结合蒸渗仪、气象与作物生育期观测，经质量控制与事件识别后，使用 XGBoost 与 SHAP 识别环境控制因子，并评估水分收支偏差。",
    featuredSummary:
      "多站点蒸渗仪与气象观测揭示不同农田中被忽略的夜间水分输入何时发生。XGBoost 与 SHAP 用于识别其环境控制，并量化对农业生态系统水分核算的影响。",
    shortSummary:
      "这项多站点研究量化不同作物与地表条件下常被忽略的夜间大气水分输入。",
    output: "口头报告，WCSS 2026 · 稿件准备中",
    ...
    caseStudy: {
      context:
        "非降水水分（包括露水及相关夜间质量增加）常被排除在农业生态系统水分收支之外，但在缺乏降雨时仍可能贡献地表湿度。本研究关注这些小通量在何时大到足以影响农田水分输入核算，并将所得关联视为观测关联，而非单一因果机制的证明。",
      ...
      contribution:
        "王安琪负责质量控制、事件识别及 XGBoost/SHAP 工作流开发，参与结果解释与图件制作，并正在准备第一作者稿件。",
      outputProse: "该工作已作口头报告，并正在整理为第一作者期刊稿件。此处不作为已发表成果报告。",
      outputPoints: [
  ...
  "yangtze-flood-frequency": {
    title: "长江非平稳洪水频率",
    cardSummary:
      "本研究考察 1960–2022 年长江中下游洪水频率分布如何变化。通过多步非平稳诊断、GAMLSS 与 RF–SHAP，比较四个水文站的水文气候与水库相关关联。",
    featuredSummary:
      "利用四个长江水文站 63 年记录，结合非平稳诊断、GAMLSS 与 RF–SHAP，比较洪水分布变化及其与水文气候和水库因子的关联。",
    shortSummary: "本研究考察 1960–2022 年长江中下游洪水频率分布如何变化。",
    output: "审稿中，期刊：Journal of Hydrology: Regional Studies",
    ...
    caseStudy: {
      context:
        "大型受控河流的洪水频率分析受非平稳性影响。长江中下游具有较长实测记录，水文气候变率与水库运行都可能留下统计印记。本研究定位为解释性与诊断性分析，而非预报模型，并避免对水库或气候模态作出决定性归因。",
      ...
      findings:
        "分析刻画了洪水频率分布在站点之间及随时间的变化，以及这些变化如何与水文气候和水库相关指数共变。结果被解释为有助于诊断非平稳性的关联，而非对任一单一驱动因子的因果归因。",
      contribution:
        "王安琪参与水文时间序列分析、非平稳诊断、GAMLSS 建模，以及水文气候与水库相关关联的解释。",
      outputProse: "稿件正在审稿，与已发表成果分开列出。",
  ...
  "ice-core-volcanic-signals": {
    title: "冰芯火山信号与年代学",
    cardSummary:
      "本项目发展从南极冰芯化学记录中识别火山信号的定量方法。研究整合形态感知窗口特征、XGBoost 基准比较、事件库匹配与年龄偏差分析，同时评估事件检测与年代对齐。",
    featuredSummary:
      "利用形态感知特征与 XGBoost 检测南极冰芯化学中的火山信号，并通过事件库匹配与年龄偏差分析将信号检测与古气候年代学联系起来。",
    shortSummary: "本项目发展从南极冰芯化学记录中识别火山信号的定量方法。",
    output: "稿件准备中",
    ...
    caseStudy: {
      context:
        "火山硫酸盐层被广泛用作年代标记，但在噪声较大的冰芯化学记录中，检测结果对阈值选择和不规则时间分辨率仍然敏感。因此，本项目将检测与年代学视为相互联系的问题：候选事件需与独立汇编比对，错配可理解为年龄偏差，而不仅仅是分类错误。",
      ...
      findings:
        "在 ±3 年匹配窗口下，机器学习流程的 F1 = 0.441，常规 Peaks 方法为 F1 = 0.280。同一框架也用于考察火山层如何支持年代对齐，而不是宣称适用于所有检测设置的单一精度。",
      contribution:
        "王安琪在跨学科合作中参与年代对齐、信号窗口特征工程、模型基准比较、误差分析、科学可视化与稿件撰写。",
      outputProse: "第一作者稿件准备中。此处不作为已发表成果报告。",
      outputPoints: ["稿件准备中"],
      relatedMethods: [
        "时间序列分段",
        "形态特征工程",
  ...
  "yangtze-delta-resilience": {
    title: "长三角生态韧性",
    cardSummary:
      "这项为期 24 年的研究追踪长三角 27 个城市的生态韧性变化、追赶动态与碳相关约束。利用多源空间数据，结合 Random Forest、SHAP 与结构方程模型，区分时间收敛与持续的空间差异。",
    featuredSummary:
      "多源数据追踪 2000–2023 年 27 个城市的生态韧性变化与碳约束。Random Forest、SHAP 与结构方程模型用于考察空间差异与追赶动态。",
    shortSummary:
      "这项为期 24 年的研究追踪长三角 27 个城市的生态韧性变化、追赶动态与碳相关约束。",
    output: "审稿中，期刊：Cities",
    ...
    caseStudy: {
      context:
        "长三角快速城市化重塑了生态潜力、弹性、稳定性与综合韧性。分析旨在把时间上的追赶与持续的空间结构区分开来，并在不把空间关联转化为因果叙事的前提下，把碳相关约束纳入视野。",
      ...
      findings:
        "地图与模型描述了 2000–2023 年韧性相关指标的演变，以及追赶动态如何与持续空间差异并存。分析中报告的收敛拟合约为 R² = 0.972，应理解为统计关联，而非因果机制的证据。",
      contribution:
        "王安琪为目前审稿中的合作论文贡献了定量分析、结果解释与稿件撰写。",
      outputProse: "稿件正在审稿，与已发表成果分开列出。",
  ...
  "marine-biogeochemistry": {
    ...
    caseStudy: {
      context:
        "该项清华大学相关合作开展于 2023 年 11 月至 2024 年 3 月，关注利用观测记录与地球系统模式输出研究全球海洋碳酸根离子变率，并不构成独立第一作者项目或已完成论文。",
      data: "合作汇集了描述与碳酸根离子条件相关的物理和生物地球化学预测变量的观测产品与地球系统模式场，这些资料在空间覆盖、时间结构与变量定义上并不一致。",
      approach:
        "跨来源统一物理与生物地球化学预测变量，并筛查一致性与空间覆盖。随后将结果整理为可复现、可用于模型分析的数据集，以支持后续环境关系的机器学习分析。",
      approachTitle: "数据整合",
      findings:
        "贡献主要是方法性的：建立从异构观测与模式档案到分析就绪场的可记录路径。此处不声称独立第一作者结果或已完成论文。",
      findingsTitle: "工作定位",
      contribution:
        "王安琪负责跨异构观测与模式数据集统一环境预测变量，开展一致性与覆盖检查，准备可复现的模型就绪数据，并参与环境关系的机器学习分析。",
      outputProse:
        "该工作记录为清华大学相关合作研究，而非独立第一作者项目或已发表论文。",
      outputPoints: [
        "清华大学相关合作项目",
        "2023年11月–2024年3月",
        "合作研究",
  ...
  "seagrass-restoration": {
    ...
    caseStudy: {
      ...
      contribution:
        "王安琪设计模拟实验，用面向对象编程实现空间显式元胞自动机模型，测试不同初始种植与环境情景，分析覆盖与生长结果，进行统计比较，完成科学可视化，并撰写硕士学位论文。",
  ...
  "metal-coselection": {
    ...
    caseStudy: {
      ...
      contribution:
        "王安琪发展并应用建模流程，处理 WHAM VII 输出，考察土壤化学与金属形态如何影响共选择估计，完成分析与可视化，并撰写本科学位论文。",
  ...
  "ocean-current-dependence": {
    ...
    caseStudy: {
      ...
      contribution:
        "王安琪在清华大学科研实习期间处理并整合时间序列，实现 R-vine 模型，并完成相关可视化。",
  ...
  "pacific-pollutant-transport": {
    ...
    caseStudy: {
      ...
      contribution:
        "王安琪在纽约大学科研实习期间完成建模，并随后以独立作者书章发表。",
